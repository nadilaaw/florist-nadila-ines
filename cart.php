...
<head>
    ...
    <title>Fleur & Co. - cart page</title>
</head>
<body>
    ...
    <div class="main">
        ...
        <section class="products">
            ...
            <?php
                ...
                <form method="post" action="" class="box">
                    ...
                    <div class="flex">
                        ...
                        <input type="number" name="qty" required min="1" value="<?=$fetch_cart['qty']; ?>" max="20" maxlength="2" class="qty">
            ...
            <div class="cart-total">
                <p>total amount payable <span>Rp <?= $grand_total; ?>/-</span></p>
                <div class="button">
                    <form method="post">
